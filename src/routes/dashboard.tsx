    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="mb-12">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-12">
         {[
           { label: t('dashboard.members'), value: membres.length.toString(), className: "text-primary", icon: <User size={24} className="text-primary opacity-20" /> },
           { label: t('dashboard.tournaments'), value: tournois.length.toString(), className: "text-foreground", icon: <div className="w-6 h-6 rounded-full border-2 border-foreground opacity-20"></div> },
           { label: t('dashboard.performances'), value: "0", className: "text-foreground", icon: <div className="w-6 h-6 rounded-full bg-foreground opacity-20"></div> },
         ].map((stat) => (
           ...
           <div className="space-y-3">
             <button className="w-full text-left px-6 py-4 border border-border bg-background hover:border-primary/60 transition-all duration-300 flex items-center gap-4">
               ...
               <div className="flex-1 min-w-0">
                 <div className="font-medium">{t('dashboard.organizeTournament')}</div>
                 <div className="text-muted-foreground text-sm hidden md:block">{t('dashboard.organizeTournamentDesc')}</div>
               </div>
             </button>
             <button className="w-full text-left px-6 py-4 border border-border bg-background hover:border-primary/60 transition-all duration-300 flex items-center gap-4">
               <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0">
               ...
               <div className="flex-1 min-w-0">
                 <div className="font-medium">{t('dashboard.inviteMember')}</div>
                 <div className="text-muted-foreground text-sm hidden md:block">{t('dashboard.inviteMemberDesc')}</div>
               </div>
             </button>
             <button className="w-full text-left px-6 py-4 border border-border bg-background hover:border-primary/60 transition-all duration-300 flex items-center gap-4">
               <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0">
               ...
               <div className="flex-1 min-w-0">
                 <div className="font-medium">{t('dashboard.viewStats')}</div>
                 <div className="text-muted-foreground text-sm hidden md:block">{t('dashboard.viewStatsDesc')}</div>
               </div>
             </button>
           </div>
         </div>
